...
namespace Org.BouncyCastle.Crypto.Engines
{
	...
	{
		// Token: 0x06001C40 RID: 7232 RVA: 0x0009EB9C File Offset: 0x0009EB9C
		public virtual int[] GetWorkingKey()
		{
			return this.workingKey;
		}

		// Token: 0x06001C41 RID: 7233 RVA: 0x0009EBA4 File Offset: 0x0009EBA4
		...
		// (get) Token: 0x06001C42 RID: 7234 RVA: 0x0009EBE0 File Offset: 0x0009EBE0
		...
		// (get) Token: 0x06001C43 RID: 7235 RVA: 0x0009EBE8 File Offset: 0x0009EBE8
		...
		// Token: 0x06001C44 RID: 7236 RVA: 0x0009EBEC File Offset: 0x0009EBEC
		public virtual int GetBlockSize()
		{
			return 8;
		}

		// Token: 0x06001C45 RID: 7237 RVA: 0x0009EBF0 File Offset: 0x0009EBF0
		...
		// Token: 0x06001C46 RID: 7238 RVA: 0x0009EC44 File Offset: 0x0009EC44
		public virtual void Reset()
		{
		}

		// Token: 0x06001C47 RID: 7239 RVA: 0x0009EC48 File Offset: 0x0009EC48
			...
			for (int j = 0; j < 16; j++)
			{
				...
				for (int m = 0; m < 24; m++)
				{
					if (array3[(int)DesEngine.pc2[m]])
					{
						int[] array4;
						IntPtr intPtr;
						(array4 = array)[(int)(intPtr = (IntPtr)num2)] = (array4[(int)intPtr] | DesEngine.bigbyte[m]);
					}
					if (array3[(int)DesEngine.pc2[m + 24]])
					{
						int[] array4;
						IntPtr intPtr;
						(array4 = array)[(int)(intPtr = (IntPtr)num3)] = (array4[(int)intPtr] | DesEngine.bigbyte[m]);
					}
				}
			}
		...
		// Token: 0x06001C48 RID: 7240 RVA: 0x0009EE54 File Offset: 0x0009EE54
