...
namespace Org.BouncyCastle.Crypto.Engines
{
	...
	{
		// Token: 0x06001B81 RID: 7041 RVA: 0x00094FEC File Offset: 0x00094FEC
		private static uint Shift(uint r, int shift)
		{
			return r >> shift | r << 32 - shift;
		}

		// Token: 0x06001B82 RID: 7042 RVA: 0x00095000 File Offset: 0x00095000
		private static uint FFmulX(uint x)
		{
			return (x & 2139062143U) << 1 ^ ((x & 2155905152U) >> 7) * 27U;
		}

		// Token: 0x06001B83 RID: 7043 RVA: 0x00095018 File Offset: 0x00095018
		...
		// Token: 0x06001B84 RID: 7044 RVA: 0x0009504C File Offset: 0x0009504C
		...
		// Token: 0x06001B85 RID: 7045 RVA: 0x0009508C File Offset: 0x0009508C
		...
		// Token: 0x06001B86 RID: 7046 RVA: 0x000950E8 File Offset: 0x000950E8
		...
		// Token: 0x06001B88 RID: 7048 RVA: 0x00095734 File Offset: 0x00095734
		...
		// (get) Token: 0x06001B89 RID: 7049 RVA: 0x000957A4 File Offset: 0x000957A4
		...
		// (get) Token: 0x06001B8A RID: 7050 RVA: 0x000957AC File Offset: 0x000957AC
		...
		// Token: 0x06001B8B RID: 7051 RVA: 0x000957B0 File Offset: 0x000957B0
		public virtual int GetBlockSize()
		{
			return 16;
		}

		// Token: 0x06001B8C RID: 7052 RVA: 0x000957B4 File Offset: 0x000957B4
		...
		// Token: 0x06001B8D RID: 7053 RVA: 0x00095834 File Offset: 0x00095834
		public virtual void Reset()
		{
		}

		// Token: 0x06001B8E RID: 7054 RVA: 0x00095838 File Offset: 0x00095838
		...
		// Token: 0x06001B8F RID: 7055 RVA: 0x00095878 File Offset: 0x00095878
		...
		// Token: 0x06001B90 RID: 7056 RVA: 0x000958B8 File Offset: 0x000958B8
		private void EncryptBlock(uint[][] KW)
		{
			...
			num4 = (AesEngine.T0[(int)((UIntPtr)(num4 & 255U))] ^ AesEngine.Shift(AesEngine.T0[(int)((UIntPtr)(num >> 8 & 255U))], 24) ^ AesEngine.Shift(AesEngine.T0[(int)((UIntPtr)(num2 >> 16 & 255U))], 16) ^ AesEngine.Shift(AesEngine.T0[(int)((UIntPtr)(num3 >> 24 & 255U))], 8) ^ array[3]);
			array = KW[i];
			this.C0 = (uint)((int)AesEngine.S[(int)((UIntPtr)(num5 & 255U))] ^ (int)AesEngine.S[(int)((UIntPtr)(num6 >> 8 & 255U))] << 8 ^ (int)this.s[(int)((UIntPtr)(num7 >> 16 & 255U))] << 16 ^ (int)this.s[(int)((UIntPtr)(num4 >> 24 & 255U))] << 24 ^ (int)array[0]);
			this.C1 = (uint)((int)this.s[(int)((UIntPtr)(num6 & 255U))] ^ (int)AesEngine.S[(int)((UIntPtr)(num7 >> 8 & 255U))] << 8 ^ (int)AesEngine.S[(int)((UIntPtr)(num4 >> 16 & 255U))] << 16 ^ (int)this.s[(int)((UIntPtr)(num5 >> 24 & 255U))] << 24 ^ (int)array[1]);
			this.C2 = (uint)((int)this.s[(int)((UIntPtr)(num7 & 255U))] ^ (int)AesEngine.S[(int)((UIntPtr)(num4 >> 8 & 255U))] << 8 ^ (int)AesEngine.S[(int)((UIntPtr)(num5 >> 16 & 255U))] << 16 ^ (int)AesEngine.S[(int)((UIntPtr)(num6 >> 24 & 255U))] << 24 ^ (int)array[2]);
			this.C3 = (uint)((int)this.s[(int)((UIntPtr)(num4 & 255U))] ^ (int)this.s[(int)((UIntPtr)(num5 >> 8 & 255U))] << 8 ^ (int)this.s[(int)((UIntPtr)(num6 >> 16 & 255U))] << 16 ^ (int)AesEngine.S[(int)((UIntPtr)(num7 >> 24 & 255U))] << 24 ^ (int)array[3]);
		}

		// Token: 0x06001B91 RID: 7057 RVA: 0x00095F1C File Offset: 0x00095F1C
		private void DecryptBlock(uint[][] KW)
		{
			...
			num4 = (AesEngine.Tinv0[(int)((UIntPtr)(num4 & 255U))] ^ AesEngine.Shift(AesEngine.Tinv0[(int)((UIntPtr)(num3 >> 8 & 255U))], 24) ^ AesEngine.Shift(AesEngine.Tinv0[(int)((UIntPtr)(num2 >> 16 & 255U))], 16) ^ AesEngine.Shift(AesEngine.Tinv0[(int)((UIntPtr)(num >> 24 & 255U))], 8) ^ array[3]);
			array = KW[0];
			this.C0 = (uint)((int)AesEngine.Si[(int)((UIntPtr)(num5 & 255U))] ^ (int)this.s[(int)((UIntPtr)(num4 >> 8 & 255U))] << 8 ^ (int)this.s[(int)((UIntPtr)(num7 >> 16 & 255U))] << 16 ^ (int)AesEngine.Si[(int)((UIntPtr)(num6 >> 24 & 255U))] << 24 ^ (int)array[0]);
			this.C1 = (uint)((int)this.s[(int)((UIntPtr)(num6 & 255U))] ^ (int)this.s[(int)((UIntPtr)(num5 >> 8 & 255U))] << 8 ^ (int)AesEngine.Si[(int)((UIntPtr)(num4 >> 16 & 255U))] << 16 ^ (int)this.s[(int)((UIntPtr)(num7 >> 24 & 255U))] << 24 ^ (int)array[1]);
			this.C2 = (uint)((int)this.s[(int)((UIntPtr)(num7 & 255U))] ^ (int)AesEngine.Si[(int)((UIntPtr)(num6 >> 8 & 255U))] << 8 ^ (int)AesEngine.Si[(int)((UIntPtr)(num5 >> 16 & 255U))] << 16 ^ (int)this.s[(int)((UIntPtr)(num4 >> 24 & 255U))] << 24 ^ (int)array[2]);
			this.C3 = (uint)((int)AesEngine.Si[(int)((UIntPtr)(num4 & 255U))] ^ (int)this.s[(int)((UIntPtr)(num7 >> 8 & 255U))] << 8 ^ (int)this.s[(int)((UIntPtr)(num6 >> 16 & 255U))] << 16 ^ (int)this.s[(int)((UIntPtr)(num5 >> 24 & 255U))] << 24 ^ (int)array[3]);
		}
