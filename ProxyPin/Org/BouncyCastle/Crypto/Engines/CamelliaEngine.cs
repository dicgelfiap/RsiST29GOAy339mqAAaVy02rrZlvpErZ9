...
namespace Org.BouncyCastle.Crypto.Engines
{
	...
	{
		// Token: 0x06001BCF RID: 7119 RVA: 0x00099888 File Offset: 0x00099888
		private static uint rightRotate(uint x, int s)
		{
			return (x >> s) + (x << 32 - s);
		}

		// Token: 0x06001BD0 RID: 7120 RVA: 0x0009989C File Offset: 0x0009989C
		private static uint leftRotate(uint x, int s)
		{
			return (x << s) + (x >> 32 - s);
		}

		// Token: 0x06001BD1 RID: 7121 RVA: 0x000998B0 File Offset: 0x000998B0
		...
		// Token: 0x06001BD2 RID: 7122 RVA: 0x0009995C File Offset: 0x0009995C
		...
		// Token: 0x06001BD3 RID: 7123 RVA: 0x00099A08 File Offset: 0x00099A08
		...
		// Token: 0x06001BD4 RID: 7124 RVA: 0x00099AC0 File Offset: 0x00099AC0
		...
		// Token: 0x06001BD5 RID: 7125 RVA: 0x00099B78 File Offset: 0x00099B78
		...
		// Token: 0x06001BD6 RID: 7126 RVA: 0x00099BA8 File Offset: 0x00099BA8
		...
		// Token: 0x06001BD7 RID: 7127 RVA: 0x00099BD8 File Offset: 0x00099BD8
		private static void camelliaF2(uint[] s, uint[] skey, int keyoff)
		{
			...
			s[2] = (s[2] ^ (num2 ^ num4));
			s[3] = (s[3] ^ (num2 ^ num4 ^ CamelliaEngine.rightRotate(num2, 8)));
			...
			num4 ^= CamelliaEngine.SBOX2_0222[(int)((byte)(num3 >> 24))];
			s[0] = (s[0] ^ (num2 ^ num4));
			s[1] = (s[1] ^ (num2 ^ num4 ^ CamelliaEngine.rightRotate(num2, 8)));
		}

		// Token: 0x06001BD8 RID: 7128 RVA: 0x00099D20 File Offset: 0x00099D20
		private static void camelliaFLs(uint[] s, uint[] fkey, int keyoff)
		{
			s[1] = (s[1] ^ CamelliaEngine.leftRotate(s[0] & fkey[keyoff], 1));
			s[0] = (s[0] ^ (fkey[1 + keyoff] | s[1]));
			s[2] = (s[2] ^ (fkey[3 + keyoff] | s[3]));
			s[3] = (s[3] ^ CamelliaEngine.leftRotate(fkey[2 + keyoff] & s[2], 1));
		}

		// Token: 0x06001BD9 RID: 7129 RVA: 0x00099D84 File Offset: 0x00099D84
		...
		// Token: 0x06001BDA RID: 7130 RVA: 0x0009A500 File Offset: 0x0009A500
		...
		// Token: 0x06001BDB RID: 7131 RVA: 0x0009A6B8 File Offset: 0x0009A6B8
		...
		// Token: 0x06001BDD RID: 7133 RVA: 0x0009A90C File Offset: 0x0009A90C
		...
		// (get) Token: 0x06001BDE RID: 7134 RVA: 0x0009A940 File Offset: 0x0009A940
		...
		// (get) Token: 0x06001BDF RID: 7135 RVA: 0x0009A948 File Offset: 0x0009A948
		...
		// Token: 0x06001BE0 RID: 7136 RVA: 0x0009A94C File Offset: 0x0009A94C
		public virtual int GetBlockSize()
		{
			return 16;
		}

		// Token: 0x06001BE1 RID: 7137 RVA: 0x0009A950 File Offset: 0x0009A950
		...
		// Token: 0x06001BE2 RID: 7138 RVA: 0x0009A9B8 File Offset: 0x0009A9B8
