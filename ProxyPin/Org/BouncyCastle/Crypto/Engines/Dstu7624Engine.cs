...
namespace Org.BouncyCastle.Crypto.Engines
{
	...
	{
		// Token: 0x06001C5A RID: 7258 RVA: 0x0009F8D8 File Offset: 0x0009F8D8
		...
		// Token: 0x06001C5B RID: 7259 RVA: 0x0009F938 File Offset: 0x0009F938
		...
		// Token: 0x06001C5C RID: 7260 RVA: 0x0009FACC File Offset: 0x0009FACC
		private void WorkingKeyExpandKT(ulong[] workingKey, ulong[] tempKeys)
		{
			...
			this.internalState = new ulong[this.wordsInBlock];
			ulong[] array3;
			(array3 = this.internalState)[0] = array3[0] + (ulong)((long)(this.wordsInBlock + this.wordsInKey + 1));
			...
			{
				IntPtr intPtr;
				(array3 = this.internalState)[(int)(intPtr = (IntPtr)i)] = array3[(int)intPtr] + array[i];
			}
			this.EncryptionRound();
			for (int j = 0; j < this.internalState.Length; j++)
			{
				IntPtr intPtr;
				(array3 = this.internalState)[(int)(intPtr = (IntPtr)j)] = (array3[(int)intPtr] ^ array2[j]);
			}
			this.EncryptionRound();
			for (int k = 0; k < this.internalState.Length; k++)
			{
				IntPtr intPtr;
				(array3 = this.internalState)[(int)(intPtr = (IntPtr)k)] = array3[(int)intPtr] + array[k];
			}
			this.EncryptionRound();
			Array.Copy(this.internalState, 0, tempKeys, 0, this.wordsInBlock);
		}

		// Token: 0x06001C5D RID: 7261 RVA: 0x0009FC28 File Offset: 0x0009FC28
		private void WorkingKeyExpandEven(ulong[] workingKey, ulong[] tempKey)
		{
			...
			for (;;)
			{
				...
				for (int k = 0; k < this.wordsInBlock; k++)
				{
					ulong[] array3;
					IntPtr intPtr;
					(array3 = this.internalState)[(int)(intPtr = (IntPtr)k)] = (array3[(int)intPtr] ^ array2[k]);
				}
				this.EncryptionRound();
				for (int l = 0; l < this.wordsInBlock; l++)
				{
					ulong[] array3;
					IntPtr intPtr;
					(array3 = this.internalState)[(int)(intPtr = (IntPtr)l)] = array3[(int)intPtr] + array2[l];
				}
				...
				if (this.wordsInKey != this.wordsInBlock)
				{
					...
					for (int num3 = 0; num3 < this.wordsInBlock; num3++)
					{
						ulong[] array3;
						IntPtr intPtr;
						(array3 = this.internalState)[(int)(intPtr = (IntPtr)num3)] = (array3[(int)intPtr] ^ array2[num3]);
					}
					this.EncryptionRound();
					for (int num4 = 0; num4 < this.wordsInBlock; num4++)
					{
						ulong[] array3;
						IntPtr intPtr;
						(array3 = this.internalState)[(int)(intPtr = (IntPtr)num4)] = array3[(int)intPtr] + array2[num4];
					}
					Array.Copy(this.internalState, 0, this.roundKeys[num], 0, this.wordsInBlock);
					if (this.roundsAmount == num)
					{
		...
		// Token: 0x06001C5E RID: 7262 RVA: 0x0009FE94 File Offset: 0x0009FE94
		...
		// Token: 0x06001C5F RID: 7263 RVA: 0x0009FEDC File Offset: 0x0009FEDC
		...
		// Token: 0x06001C60 RID: 7264 RVA: 0x000A0018 File Offset: 0x000A0018
		...
		// Token: 0x06001C61 RID: 7265 RVA: 0x000A002C File Offset: 0x000A002C
		...
		// Token: 0x06001C62 RID: 7266 RVA: 0x000A0040 File Offset: 0x000A0040
		private void DecryptBlock_128(byte[] input, int inOff, byte[] output, int outOff)
		{
			...
			for (;;)
			{
				...
				byte b = Dstu7624Engine.T0[(int)((UIntPtr)(num4 & 255U))];
				byte b2 = Dstu7624Engine.T1[(int)((UIntPtr)(num4 >> 8 & 255U))];
				byte b3 = Dstu7624Engine.T2[(int)((UIntPtr)(num4 >> 16 & 255U))];
				byte b4 = Dstu7624Engine.T3[(int)((UIntPtr)(num4 >> 24))];
				num4 = (uint)((int)b | (int)b2 << 8 | (int)b3 << 16 | (int)b4 << 24);
				byte b5 = Dstu7624Engine.T0[(int)((UIntPtr)(num7 & 255U))];
				byte b6 = Dstu7624Engine.T1[(int)((UIntPtr)(num7 >> 8 & 255U))];
				byte b7 = Dstu7624Engine.T2[(int)((UIntPtr)(num7 >> 16 & 255U))];
				byte b8 = Dstu7624Engine.T3[(int)((UIntPtr)(num7 >> 24))];
				num7 = (uint)((int)b5 | (int)b6 << 8 | (int)b7 << 16 | (int)b8 << 24);
				num = ((ulong)num4 | (ulong)num7 << 32);
				byte b9 = Dstu7624Engine.T0[(int)((UIntPtr)(num6 & 255U))];
				byte b10 = Dstu7624Engine.T1[(int)((UIntPtr)(num6 >> 8 & 255U))];
				byte b11 = Dstu7624Engine.T2[(int)((UIntPtr)(num6 >> 16 & 255U))];
				byte b12 = Dstu7624Engine.T3[(int)((UIntPtr)(num6 >> 24))];
				num6 = (uint)((int)b9 | (int)b10 << 8 | (int)b11 << 16 | (int)b12 << 24);
				byte b13 = Dstu7624Engine.T0[(int)((UIntPtr)(num5 & 255U))];
				byte b14 = Dstu7624Engine.T1[(int)((UIntPtr)(num5 >> 8 & 255U))];
				byte b15 = Dstu7624Engine.T2[(int)((UIntPtr)(num5 >> 16 & 255U))];
				byte b16 = Dstu7624Engine.T3[(int)((UIntPtr)(num5 >> 24))];
				num5 = (uint)((int)b13 | (int)b14 << 8 | (int)b15 << 16 | (int)b16 << 24);
		...
		// Token: 0x06001C63 RID: 7267 RVA: 0x000A0284 File Offset: 0x000A0284
		private void EncryptBlock_128(byte[] input, int inOff, byte[] output, int outOff)
		{
			...
			for (;;)
			{
				...
				uint num6 = (uint)num2;
				uint num7 = (uint)(num2 >> 32);
				byte b = Dstu7624Engine.S0[(int)((UIntPtr)(num4 & 255U))];
				byte b2 = Dstu7624Engine.S1[(int)((UIntPtr)(num4 >> 8 & 255U))];
				byte b3 = Dstu7624Engine.S2[(int)((UIntPtr)(num4 >> 16 & 255U))];
				byte b4 = Dstu7624Engine.S3[(int)((UIntPtr)(num4 >> 24))];
				num4 = (uint)((int)b | (int)b2 << 8 | (int)b3 << 16 | (int)b4 << 24);
				byte b5 = Dstu7624Engine.S0[(int)((UIntPtr)(num7 & 255U))];
				byte b6 = Dstu7624Engine.S1[(int)((UIntPtr)(num7 >> 8 & 255U))];
				byte b7 = Dstu7624Engine.S2[(int)((UIntPtr)(num7 >> 16 & 255U))];
				byte b8 = Dstu7624Engine.S3[(int)((UIntPtr)(num7 >> 24))];
				num7 = (uint)((int)b5 | (int)b6 << 8 | (int)b7 << 16 | (int)b8 << 24);
				num = ((ulong)num4 | (ulong)num7 << 32);
				byte b9 = Dstu7624Engine.S0[(int)((UIntPtr)(num6 & 255U))];
				byte b10 = Dstu7624Engine.S1[(int)((UIntPtr)(num6 >> 8 & 255U))];
				byte b11 = Dstu7624Engine.S2[(int)((UIntPtr)(num6 >> 16 & 255U))];
				byte b12 = Dstu7624Engine.S3[(int)((UIntPtr)(num6 >> 24))];
				num6 = (uint)((int)b9 | (int)b10 << 8 | (int)b11 << 16 | (int)b12 << 24);
				byte b13 = Dstu7624Engine.S0[(int)((UIntPtr)(num5 & 255U))];
				byte b14 = Dstu7624Engine.S1[(int)((UIntPtr)(num5 >> 8 & 255U))];
				byte b15 = Dstu7624Engine.S2[(int)((UIntPtr)(num5 >> 16 & 255U))];
				byte b16 = Dstu7624Engine.S3[(int)((UIntPtr)(num5 >> 24))];
				num5 = (uint)((int)b13 | (int)b14 << 8 | (int)b15 << 16 | (int)b16 << 24);
				num2 = ((ulong)num6 | (ulong)num5 << 32);
		...
		// Token: 0x06001C64 RID: 7268 RVA: 0x000A04C8 File Offset: 0x000A04C8
		private void SubBytes()
		{
			for (int i = 0; i < this.wordsInBlock; i++)
			{
				...
				byte b = Dstu7624Engine.S0[(int)((UIntPtr)(num2 & 255U))];
				byte b2 = Dstu7624Engine.S1[(int)((UIntPtr)(num2 >> 8 & 255U))];
				byte b3 = Dstu7624Engine.S2[(int)((UIntPtr)(num2 >> 16 & 255U))];
				byte b4 = Dstu7624Engine.S3[(int)((UIntPtr)(num2 >> 24))];
				num2 = (uint)((int)b | (int)b2 << 8 | (int)b3 << 16 | (int)b4 << 24);
				byte b5 = Dstu7624Engine.S0[(int)((UIntPtr)(num3 & 255U))];
				byte b6 = Dstu7624Engine.S1[(int)((UIntPtr)(num3 >> 8 & 255U))];
				byte b7 = Dstu7624Engine.S2[(int)((UIntPtr)(num3 >> 16 & 255U))];
				byte b8 = Dstu7624Engine.S3[(int)((UIntPtr)(num3 >> 24))];
				num3 = (uint)((int)b5 | (int)b6 << 8 | (int)b7 << 16 | (int)b8 << 24);
				this.internalState[i] = ((ulong)num2 | (ulong)num3 << 32);
			}
		}

		// Token: 0x06001C65 RID: 7269 RVA: 0x000A05C0 File Offset: 0x000A05C0
		private void InvSubBytes()
		{
			for (int i = 0; i < this.wordsInBlock; i++)
			{
				...
				uint num2 = (uint)num;
				uint num3 = (uint)(num >> 32);
				byte b = Dstu7624Engine.T0[(int)((UIntPtr)(num2 & 255U))];
				byte b2 = Dstu7624Engine.T1[(int)((UIntPtr)(num2 >> 8 & 255U))];
				byte b3 = Dstu7624Engine.T2[(int)((UIntPtr)(num2 >> 16 & 255U))];
				byte b4 = Dstu7624Engine.T3[(int)((UIntPtr)(num2 >> 24))];
				num2 = (uint)((int)b | (int)b2 << 8 | (int)b3 << 16 | (int)b4 << 24);
				byte b5 = Dstu7624Engine.T0[(int)((UIntPtr)(num3 & 255U))];
				byte b6 = Dstu7624Engine.T1[(int)((UIntPtr)(num3 >> 8 & 255U))];
				byte b7 = Dstu7624Engine.T2[(int)((UIntPtr)(num3 >> 16 & 255U))];
				byte b8 = Dstu7624Engine.T3[(int)((UIntPtr)(num3 >> 24))];
				num3 = (uint)((int)b5 | (int)b6 << 8 | (int)b7 << 16 | (int)b8 << 24);
				this.internalState[i] = ((ulong)num2 | (ulong)num3 << 32);
			}
		}

		// Token: 0x06001C66 RID: 7270 RVA: 0x000A06B8 File Offset: 0x000A06B8
		...
		// Token: 0x06001C67 RID: 7271 RVA: 0x000A0A18 File Offset: 0x000A0A18
		...
		// Token: 0x06001C68 RID: 7272 RVA: 0x000A0D78 File Offset: 0x000A0D78
		private void AddRoundKey(int round)
		{
			...
			for (int i = 0; i < this.wordsInBlock; i++)
			{
				ulong[] array2;
				IntPtr intPtr;
				(array2 = this.internalState)[(int)(intPtr = (IntPtr)i)] = array2[(int)intPtr] + array[i];
			}
		}

		// Token: 0x06001C69 RID: 7273 RVA: 0x000A0DC0 File Offset: 0x000A0DC0
		...
		// Token: 0x06001C6A RID: 7274 RVA: 0x000A0E08 File Offset: 0x000A0E08
		...
		// Token: 0x06001C6B RID: 7275 RVA: 0x000A0E50 File Offset: 0x000A0E50
		...
		// Token: 0x06001C6C RID: 7276 RVA: 0x000A0EB0 File Offset: 0x000A0EB0
		...
		// Token: 0x06001C6D RID: 7277 RVA: 0x000A0EEC File Offset: 0x000A0EEC
		...
		// Token: 0x06001C6E RID: 7278 RVA: 0x000A0FE0 File Offset: 0x000A0FE0
		...
		// Token: 0x06001C6F RID: 7279 RVA: 0x000A101C File Offset: 0x000A101C
		private static ulong MulX(ulong n)
		{
			return (n & 9187201950435737471UL) << 1 ^ ((n & 9259542123273814144UL) >> 7) * 29UL;
		}

		// Token: 0x06001C70 RID: 7280 RVA: 0x000A1040 File Offset: 0x000A1040
		...
		// Token: 0x06001C71 RID: 7281 RVA: 0x000A1074 File Offset: 0x000A1074
		private static ulong Rotate(int n, ulong x)
		{
			return x >> n | x << -n;
		}

		// Token: 0x06001C72 RID: 7282 RVA: 0x000A1084 File Offset: 0x000A1084
		...
		// (get) Token: 0x06001C73 RID: 7283 RVA: 0x000A11C8 File Offset: 0x000A11C8
		...
		// Token: 0x06001C74 RID: 7284 RVA: 0x000A11D0 File Offset: 0x000A11D0
		...
		// (get) Token: 0x06001C75 RID: 7285 RVA: 0x000A11DC File Offset: 0x000A11DC
		...
		// Token: 0x06001C76 RID: 7286 RVA: 0x000A11E0 File Offset: 0x000A11E0
