...
namespace Org.BouncyCastle.Crypto.Utilities
{
	...
	{
		// Token: 0x06002A6B RID: 10859 RVA: 0x000E3AF0 File Offset: 0x000E3AF0
		private CipherFactory()
		{
		}

		// Token: 0x06002A6C RID: 10860 RVA: 0x000E3AF8 File Offset: 0x000E3AF8
		public static object CreateContentCipher(bool forEncryption, ICipherParameters encKey, AlgorithmIdentifier encryptionAlgID)
		{
			...
			BufferedBlockCipher bufferedBlockCipher = CipherFactory.CreateCipher(encryptionAlgID.Algorithm);
			...
			if (asn1Object != null && !(asn1Object is DerNull))
			{
				...
				else
				{
					...
					bufferedBlockCipher.Init(forEncryption, new ParametersWithIV(new RC2Parameters(((KeyParameter)encKey).GetKey(), (int)CipherFactory.rc2Ekb[instance2.RC2ParameterVersion.IntValue]), instance2.GetIV()));
				}
			}
		...
		// Token: 0x06002A6D RID: 10861 RVA: 0x000E3CF8 File Offset: 0x000E3CF8
		...
		private static readonly short[] rc2Ekb = new short[]
		{
			93,
			190,
			155,
