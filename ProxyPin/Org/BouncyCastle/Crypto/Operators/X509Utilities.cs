...
namespace Org.BouncyCastle.Crypto.Operators
{
	...
	{
		// Token: 0x06002175 RID: 8565 RVA: 0x000C2208 File Offset: 0x000C2208
		...
		// Token: 0x06002176 RID: 8566 RVA: 0x000C2704 File Offset: 0x000C2704
		...
		// Token: 0x06002177 RID: 8567 RVA: 0x000C27F8 File Offset: 0x000C27F8
		internal static string GetSignatureName(AlgorithmIdentifier sigAlgId)
		{
			...
			if (parameters != null && !X509Utilities.derNull.Equals(parameters))
			{
				if (sigAlgId.Algorithm.Equals(PkcsObjectIdentifiers.IdRsassaPss))
				{
					...
					return X509Utilities.GetDigestAlgName(instance.HashAlgorithm.Algorithm) + "withRSAandMGF1";
				}
				if (sigAlgId.Algorithm.Equals(X9ObjectIdentifiers.ECDsaWithSha2))
				{
					Asn1Sequence instance2 = Asn1Sequence.GetInstance(parameters);
					return X509Utilities.GetDigestAlgName((DerObjectIdentifier)instance2[0]) + "withECDSA";
				}
			}
			return sigAlgId.Algorithm.Id;
		}

		// Token: 0x06002178 RID: 8568 RVA: 0x000C28A0 File Offset: 0x000C28A0
		...
		// Token: 0x06002179 RID: 8569 RVA: 0x000C28C0 File Offset: 0x000C28C0
		...
		// Token: 0x0600217A RID: 8570 RVA: 0x000C28F4 File Offset: 0x000C28F4
		...
		// Token: 0x0600217B RID: 8571 RVA: 0x000C2958 File Offset: 0x000C2958
