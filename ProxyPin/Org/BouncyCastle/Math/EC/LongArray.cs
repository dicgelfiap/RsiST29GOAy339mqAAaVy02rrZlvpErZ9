...
namespace Org.BouncyCastle.Math.EC
{
	...
	{
		// Token: 0x060034CE RID: 13518 RVA: 0x00116084 File Offset: 0x00116084
		public LongArray(int intLen)
		{
			this.m_ints = new long[intLen];
		}

		// Token: 0x060034CF RID: 13519 RVA: 0x00116098 File Offset: 0x00116098
		public LongArray(long[] ints)
		{
			this.m_ints = ints;
		}

		// Token: 0x060034D0 RID: 13520 RVA: 0x001160A8 File Offset: 0x001160A8
		...
		// Token: 0x060034D1 RID: 13521 RVA: 0x001160E4 File Offset: 0x001160E4
		...
		// Token: 0x060034D2 RID: 13522 RVA: 0x00116204 File Offset: 0x00116204
		internal void CopyTo(long[] z, int zOff)
		{
			Array.Copy(this.m_ints, 0, z, zOff, this.m_ints.Length);
		}

		// Token: 0x060034D3 RID: 13523 RVA: 0x0011621C File Offset: 0x0011621C
		public bool IsOne()
		{
		...
		// Token: 0x060034D4 RID: 13524 RVA: 0x00116260 File Offset: 0x00116260
		public bool IsZero()
		{
			long[] ints = this.m_ints;
		...
		// Token: 0x060034D5 RID: 13525 RVA: 0x00116298 File Offset: 0x00116298
		public int GetUsedLength()
		{
			return this.GetUsedLengthFrom(this.m_ints.Length);
		}

		// Token: 0x060034D6 RID: 13526 RVA: 0x001162A8 File Offset: 0x001162A8
		...
		// Token: 0x060034D7 RID: 13527 RVA: 0x00116308 File Offset: 0x00116308
		public int Degree()
		{
		...
		// Token: 0x060034D8 RID: 13528 RVA: 0x00116348 File Offset: 0x00116348
		...
		// Token: 0x060034D9 RID: 13529 RVA: 0x00116384 File Offset: 0x00116384
		...
		// Token: 0x060034DA RID: 13530 RVA: 0x00116408 File Offset: 0x00116408
		...
		// Token: 0x060034DB RID: 13531 RVA: 0x00116440 File Offset: 0x00116440
		...
		// Token: 0x060034DC RID: 13532 RVA: 0x00116530 File Offset: 0x00116530
		...
		// Token: 0x060034DD RID: 13533 RVA: 0x00116574 File Offset: 0x00116574
		...
		// Token: 0x060034DE RID: 13534 RVA: 0x001165BC File Offset: 0x001165BC
		public LongArray AddOne()
		{
			...
			long[] array2;
			(array2 = array)[0] = (array2[0] ^ 1L);
			return new LongArray(array);
		}

		// Token: 0x060034DF RID: 13535 RVA: 0x00116614 File Offset: 0x00116614
		private void AddShiftedByBitsSafe(LongArray other, int otherDegree, int bits)
		{
			...
			if (num4 != 0L)
			{
				long[] ints;
				IntPtr intPtr;
				(ints = this.m_ints)[(int)(intPtr = (IntPtr)(num + num2))] = (ints[(int)intPtr] ^ num4);
			}
		}

		// Token: 0x060034E0 RID: 13536 RVA: 0x00116688 File Offset: 0x00116688
		private static long AddShiftedUp(long[] x, int xOff, long[] y, int yOff, int count, int shift)
		{
			...
			for (int i = 0; i < count; i++)
			{
				long num3 = y[yOff + i];
				IntPtr intPtr;
				x[(int)(intPtr = (IntPtr)(xOff + i))] = (x[(int)intPtr] ^ (num3 << shift | num2));
				num2 = (long)((ulong)num3 >> num);
			}
			return num2;
		}

		// Token: 0x060034E1 RID: 13537 RVA: 0x001166DC File Offset: 0x001166DC
		private static long AddShiftedDown(long[] x, int xOff, long[] y, int yOff, int count, int shift)
		{
			...
			while (--num3 >= 0)
			{
				...
				IntPtr intPtr;
				x[(int)(intPtr = (IntPtr)(xOff + num3))] = (x[(int)intPtr] ^ (long)((ulong)num4 >> shift | (ulong)num2));
				num2 = num4 << num;
			}
			return num2;
		}

		// Token: 0x060034E2 RID: 13538 RVA: 0x00116730 File Offset: 0x00116730
		...
		// Token: 0x060034E3 RID: 13539 RVA: 0x00116784 File Offset: 0x00116784
		private static void Add(long[] x, int xOff, long[] y, int yOff, int count)
		{
			for (int i = 0; i < count; i++)
			{
				IntPtr intPtr;
				x[(int)(intPtr = (IntPtr)(xOff + i))] = (x[(int)intPtr] ^ y[yOff + i]);
			}
		}

		// Token: 0x060034E4 RID: 13540 RVA: 0x001167B8 File Offset: 0x001167B8
		...
		// Token: 0x060034E5 RID: 13541 RVA: 0x001167EC File Offset: 0x001167EC
		private static void AddBoth(long[] x, int xOff, long[] y1, int y1Off, long[] y2, int y2Off, int count)
		{
			for (int i = 0; i < count; i++)
			{
				IntPtr intPtr;
				x[(int)(intPtr = (IntPtr)(xOff + i))] = (x[(int)intPtr] ^ (y1[y1Off + i] ^ y2[y2Off + i]));
			}
		}

		// Token: 0x060034E6 RID: 13542 RVA: 0x00116828 File Offset: 0x00116828
		private static void Distribute(long[] x, int src, int dst1, int dst2, int count)
		{
			for (int i = 0; i < count; i++)
			{
				long num = x[src + i];
				IntPtr intPtr;
				x[(int)(intPtr = (IntPtr)(dst1 + i))] = (x[(int)intPtr] ^ num);
				x[(int)(intPtr = (IntPtr)(dst2 + i))] = (x[(int)intPtr] ^ num);
			}
		}

		// Token: 0x17000982 RID: 2434
		// (get) Token: 0x060034E7 RID: 13543 RVA: 0x0011686C File Offset: 0x0011686C
		public int Length
		{
			get
			{
		...
		// Token: 0x060034E8 RID: 13544 RVA: 0x00116878 File Offset: 0x00116878
		private static void FlipWord(long[] buf, int off, int bit, long word)
		{
			...
			if (num2 == 0)
			{
				buf[(int)(intPtr = (IntPtr)num)] = (buf[(int)intPtr] ^ word);
				return;
			}
			buf[(int)(intPtr = (IntPtr)num)] = (buf[(int)intPtr] ^ word << num2);
			word = (long)((ulong)word >> 64 - num2);
			if (word != 0L)
			{
				buf[(int)(intPtr = (IntPtr)(num + 1))] = (buf[(int)intPtr] ^ word);
			}
		}

		// Token: 0x060034E9 RID: 13545 RVA: 0x001168DC File Offset: 0x001168DC
		public bool TestBitZero()
		{
			return this.m_ints.Length > 0 && (this.m_ints[0] & 1L) != 0L;
		}

		// Token: 0x060034EA RID: 13546 RVA: 0x00116900 File Offset: 0x00116900
		...
		// Token: 0x060034EB RID: 13547 RVA: 0x00116930 File Offset: 0x00116930
		private static void FlipBit(long[] buf, int off, int n)
		{
			...
			long num3 = 1L << num2;
			IntPtr intPtr;
			buf[(int)(intPtr = (IntPtr)(off + num))] = (buf[(int)intPtr] ^ num3);
		}

		// Token: 0x060034EC RID: 13548 RVA: 0x00116964 File Offset: 0x00116964
		private static void MultiplyWord(long a, long[] b, int bLen, long[] c, int cOff)
		{
			...
			while ((a = (long)((ulong)a >> 1)) != 0L)
			{
				if ((a & 1L) != 0L)
				{
					...
					{
						IntPtr intPtr;
						c[(int)(intPtr = (IntPtr)(cOff + bLen))] = (c[(int)intPtr] ^ num2);
					}
				}
				num++;
			}
		...
		// Token: 0x060034ED RID: 13549 RVA: 0x001169D0 File Offset: 0x001169D0
		...
		// Token: 0x060034EE RID: 13550 RVA: 0x00116C24 File Offset: 0x00116C24
		...
		// Token: 0x060034EF RID: 13551 RVA: 0x00116E2C File Offset: 0x00116E2C
		...
		// Token: 0x060034F0 RID: 13552 RVA: 0x001170E4 File Offset: 0x001170E4
		...
		// Token: 0x060034F1 RID: 13553 RVA: 0x00117118 File Offset: 0x00117118
		...
		// Token: 0x060034F2 RID: 13554 RVA: 0x0011731C File Offset: 0x0011731C
		...
		// Token: 0x060034F3 RID: 13555 RVA: 0x00117368 File Offset: 0x00117368
		...
		// Token: 0x060034F4 RID: 13556 RVA: 0x00117390 File Offset: 0x00117390
		...
		// Token: 0x060034F5 RID: 13557 RVA: 0x0011747C File Offset: 0x0011747C
		...
		// Token: 0x060034F6 RID: 13558 RVA: 0x001174A4 File Offset: 0x001174A4
		...
		// Token: 0x060034F7 RID: 13559 RVA: 0x001174E8 File Offset: 0x001174E8
		private static void ReduceWordWise(long[] buf, int off, int len, int toBit, int m, int[] ks)
		{
			...
			{
				IntPtr intPtr;
				buf[(int)(intPtr = (IntPtr)(off + num))] = (buf[(int)intPtr] ^ num4 << num3);
				LongArray.ReduceWord(buf, off, toBit, num4, m, ks);
			}
		}

		// Token: 0x060034F8 RID: 13560 RVA: 0x0011756C File Offset: 0x0011756C
		...
		// Token: 0x060034F9 RID: 13561 RVA: 0x001175AC File Offset: 0x001175AC
		...
		// Token: 0x060034FA RID: 13562 RVA: 0x001175FC File Offset: 0x001175FC
		private static void FlipVector(long[] x, int xOff, long[] y, int yOff, int yLen, int bits)
		{
			...
			IntPtr intPtr;
			x[(int)(intPtr = (IntPtr)xOff)] = (x[(int)intPtr] ^ num);
		}

		// Token: 0x060034FB RID: 13563 RVA: 0x00117650 File Offset: 0x00117650
		...
		// Token: 0x060034FC RID: 13564 RVA: 0x001176C8 File Offset: 0x001176C8
		...
		// Token: 0x060034FD RID: 13565 RVA: 0x00117734 File Offset: 0x00117734
		...
		// Token: 0x060034FE RID: 13566 RVA: 0x001177A4 File Offset: 0x001177A4
		...
		// Token: 0x060034FF RID: 13567 RVA: 0x001177EC File Offset: 0x001177EC
		...
		// Token: 0x06003500 RID: 13568 RVA: 0x0011785C File Offset: 0x0011785C
		...
		// Token: 0x06003501 RID: 13569 RVA: 0x0011788C File Offset: 0x0011788C
		...
		// Token: 0x06003502 RID: 13570 RVA: 0x001178E0 File Offset: 0x001178E0
		...
		// Token: 0x06003503 RID: 13571 RVA: 0x00117930 File Offset: 0x00117930
		...
		// Token: 0x06003504 RID: 13572 RVA: 0x00117960 File Offset: 0x00117960
		...
		// Token: 0x06003505 RID: 13573 RVA: 0x001179CC File Offset: 0x001179CC
		...
		// Token: 0x06003506 RID: 13574 RVA: 0x00117A04 File Offset: 0x00117A04
		...
		// Token: 0x06003507 RID: 13575 RVA: 0x00117A34 File Offset: 0x00117A34
		...
		// Token: 0x06003508 RID: 13576 RVA: 0x00117ADC File Offset: 0x00117ADC
		...
		// Token: 0x06003509 RID: 13577 RVA: 0x00117B10 File Offset: 0x00117B10
		...
		// Token: 0x0600350A RID: 13578 RVA: 0x00117B98 File Offset: 0x00117B98
		...
		// Token: 0x0600350B RID: 13579 RVA: 0x00117BD0 File Offset: 0x00117BD0
		...
		// Token: 0x0600350C RID: 13580 RVA: 0x00117C34 File Offset: 0x00117C34
		...
		// Token: 0x0600350D RID: 13581 RVA: 0x00117E08 File Offset: 0x00117E08
		public override bool Equals(object obj)
		{
			return this.Equals(obj as LongArray);
		}

		// Token: 0x0600350E RID: 13582 RVA: 0x00117E18 File Offset: 0x00117E18
		...
		// Token: 0x0600350F RID: 13583 RVA: 0x00117E78 File Offset: 0x00117E78
		...
		// Token: 0x06003510 RID: 13584 RVA: 0x00117EC4 File Offset: 0x00117EC4
		public LongArray Copy()
		{
			return new LongArray(Arrays.Clone(this.m_ints));
		}

		// Token: 0x06003511 RID: 13585 RVA: 0x00117ED8 File Offset: 0x00117ED8
