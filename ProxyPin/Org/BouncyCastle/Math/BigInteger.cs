...
namespace Org.BouncyCastle.Math
{
	...
	{
		// Token: 0x060036BC RID: 14012 RVA: 0x00123F74 File Offset: 0x00123F74
		static BigInteger()
		{
		...
		// Token: 0x060036BD RID: 14013 RVA: 0x001246AC File Offset: 0x001246AC
		private static int GetByteLength(int nBits)
		{
			return (nBits + 8 - 1) / 8;
		}

		// Token: 0x060036BE RID: 14014 RVA: 0x001246B8 File Offset: 0x001246B8
		public static BigInteger Arbitrary(int sizeInBits)
		{
			return new BigInteger(sizeInBits, BigInteger.RandomSource);
		}

		// Token: 0x060036BF RID: 14015 RVA: 0x001246C8 File Offset: 0x001246C8
		...
		// Token: 0x060036C0 RID: 14016 RVA: 0x0012477C File Offset: 0x0012477C
		public BigInteger(string value) : this(value, 10)
		{
		}

		// Token: 0x060036C1 RID: 14017 RVA: 0x00124788 File Offset: 0x00124788
		...
		// Token: 0x060036C2 RID: 14018 RVA: 0x00124A68 File Offset: 0x00124A68
		public BigInteger(byte[] bytes) : this(bytes, 0, bytes.Length)
		{
		}

		// Token: 0x060036C3 RID: 14019 RVA: 0x00124A78 File Offset: 0x00124A78
		...
		// Token: 0x060036C4 RID: 14020 RVA: 0x00124B8C File Offset: 0x00124B8C
		...
		// Token: 0x060036C5 RID: 14021 RVA: 0x00124C50 File Offset: 0x00124C50
		public BigInteger(int sign, byte[] bytes) : this(sign, bytes, 0, bytes.Length)
		{
		}

		// Token: 0x060036C6 RID: 14022 RVA: 0x00124C60 File Offset: 0x00124C60
		...
		// Token: 0x060036C7 RID: 14023 RVA: 0x00124CE8 File Offset: 0x00124CE8
		public BigInteger(int sizeInBits, Random random)
		{
			...
			byte[] array2;
			(array2 = array)[0] = (array2[0] & (byte)(255U >> num));
			this.magnitude = BigInteger.MakeMagnitude(array, 0, array.Length);
			this.sign = ((this.magnitude.Length < 1) ? 0 : 1);
		}

		// Token: 0x060036C8 RID: 14024 RVA: 0x00124DA8 File Offset: 0x00124DA8
		public BigInteger(int bitLength, int certainty, Random random)
		{
			...
			for (;;)
			{
				random.NextBytes(array);
				byte[] array2;
				(array2 = array)[0] = (array2[0] & b);
				(array2 = array)[0] = (array2[0] | b2);
				IntPtr intPtr;
				(array2 = array)[(int)(intPtr = (IntPtr)(byteLength - 1))] = (array2[(int)intPtr] | 1);
				this.magnitude = BigInteger.MakeMagnitude(array, 0, array.Length);
				this.nBits = -1;
				this.mQuote = 0;
				if (certainty < 1)
				...
				{
					int[] array3;
					(array3 = this.magnitude)[(int)(intPtr = (IntPtr)i)] = (array3[(int)intPtr] ^ random.Next());
					if (this.CheckProbablePrime(certainty, random, true))
					{
						return;
					}
		...
		// Token: 0x060036C9 RID: 14025 RVA: 0x00124F08 File Offset: 0x00124F08
		...
		// Token: 0x060036CA RID: 14026 RVA: 0x00124F20 File Offset: 0x00124F20
		private static int[] AddMagnitudes(int[] a, int[] b)
		{
			...
			{
				IntPtr intPtr;
				while (num >= 0 && (a[(int)(intPtr = (IntPtr)(num--))] = a[(int)intPtr] + 1) == 0)
				{
				}
			}
			return a;
		...
		// Token: 0x060036CB RID: 14027 RVA: 0x00124F90 File Offset: 0x00124F90
		...
		// Token: 0x060036CC RID: 14028 RVA: 0x00125000 File Offset: 0x00125000
		...
		// Token: 0x060036CD RID: 14029 RVA: 0x0012509C File Offset: 0x0012509C
		...
		// Token: 0x060036CE RID: 14030 RVA: 0x001251FC File Offset: 0x001251FC
		...
		// (get) Token: 0x060036CF RID: 14031 RVA: 0x0012520C File Offset: 0x0012520C
		public int BitCount
		{
			get
			{
		...
		// Token: 0x060036D0 RID: 14032 RVA: 0x00125280 File Offset: 0x00125280
		...
		// Token: 0x060036D1 RID: 14033 RVA: 0x001252D0 File Offset: 0x001252D0
		...
		// (get) Token: 0x060036D2 RID: 14034 RVA: 0x00125344 File Offset: 0x00125344
		...
		// Token: 0x060036D3 RID: 14035 RVA: 0x00125384 File Offset: 0x00125384
		...
		// Token: 0x060036D4 RID: 14036 RVA: 0x001253E4 File Offset: 0x001253E4
		private bool QuickPow2Check()
		{
			return this.sign > 0 && this.nBits == 1;
		}

		// Token: 0x060036D5 RID: 14037 RVA: 0x00125400 File Offset: 0x00125400
		public int CompareTo(object obj)
		{
			return this.CompareTo((BigInteger)obj);
		}

		// Token: 0x060036D6 RID: 14038 RVA: 0x00125410 File Offset: 0x00125410
		...
		// Token: 0x060036D7 RID: 14039 RVA: 0x0012544C File Offset: 0x0012544C
		...
		// Token: 0x060036D8 RID: 14040 RVA: 0x001254A8 File Offset: 0x001254A8
		...
		// Token: 0x060036D9 RID: 14041 RVA: 0x00125508 File Offset: 0x00125508
		...
		// Token: 0x060036DA RID: 14042 RVA: 0x00125738 File Offset: 0x00125738
		...
		// Token: 0x060036DB RID: 14043 RVA: 0x001257E0 File Offset: 0x001257E0
		...
		// Token: 0x060036DC RID: 14044 RVA: 0x001258F4 File Offset: 0x001258F4
		...
		// Token: 0x060036DD RID: 14045 RVA: 0x00125938 File Offset: 0x00125938
		...
		// Token: 0x060036DE RID: 14046 RVA: 0x00125998 File Offset: 0x00125998
		...
		// Token: 0x060036DF RID: 14047 RVA: 0x001259EC File Offset: 0x001259EC
		...
		// Token: 0x060036E0 RID: 14048 RVA: 0x00125A54 File Offset: 0x00125A54
		...
		// (get) Token: 0x060036E1 RID: 14049 RVA: 0x00125AB0 File Offset: 0x00125AB0
		public int IntValue
		{
			get
			{
		...
		// (get) Token: 0x060036E2 RID: 14050 RVA: 0x00125AF4 File Offset: 0x00125AF4
		...
		// Token: 0x060036E3 RID: 14051 RVA: 0x00125B14 File Offset: 0x00125B14
		public bool IsProbablePrime(int certainty)
		{
			return this.IsProbablePrime(certainty, false);
		}

		// Token: 0x060036E4 RID: 14052 RVA: 0x00125B20 File Offset: 0x00125B20
		...
		// Token: 0x060036E5 RID: 14053 RVA: 0x00125B78 File Offset: 0x00125B78
		...
		// Token: 0x060036E6 RID: 14054 RVA: 0x00125C14 File Offset: 0x00125C14
		public bool RabinMillerTest(int certainty, Random random)
		{
			return this.RabinMillerTest(certainty, random, false);
		}

		// Token: 0x060036E7 RID: 14055 RVA: 0x00125C20 File Offset: 0x00125C20
		...
		// (get) Token: 0x060036E8 RID: 14056 RVA: 0x00125D7C File Offset: 0x00125D7C
		...
		// (get) Token: 0x060036E9 RID: 14057 RVA: 0x00125DE0 File Offset: 0x00125DE0
		...
		// Token: 0x060036EA RID: 14058 RVA: 0x00125E00 File Offset: 0x00125E00
		...
		// Token: 0x060036EB RID: 14059 RVA: 0x00125E14 File Offset: 0x00125E14
		...
		// Token: 0x060036EC RID: 14060 RVA: 0x00125E28 File Offset: 0x00125E28
		...
		// Token: 0x060036ED RID: 14061 RVA: 0x00125E70 File Offset: 0x00125E70
		...
		// Token: 0x060036EE RID: 14062 RVA: 0x00125EF0 File Offset: 0x00125EF0
		...
		// Token: 0x060036EF RID: 14063 RVA: 0x00125FA8 File Offset: 0x00125FA8
		...
		// Token: 0x060036F0 RID: 14064 RVA: 0x00125FDC File Offset: 0x00125FDC
		...
		// Token: 0x060036F1 RID: 14065 RVA: 0x00126020 File Offset: 0x00126020
		...
		// Token: 0x060036F2 RID: 14066 RVA: 0x00126090 File Offset: 0x00126090
		private static void ZeroOut(int[] x)
		{
			Array.Clear(x, 0, x.Length);
		}

		// Token: 0x060036F3 RID: 14067 RVA: 0x0012609C File Offset: 0x0012609C
		...
		// Token: 0x060036F4 RID: 14068 RVA: 0x0012616C File Offset: 0x0012616C
		...
		// Token: 0x060036F5 RID: 14069 RVA: 0x00126310 File Offset: 0x00126310
		...
		// Token: 0x060036F6 RID: 14070 RVA: 0x001263C4 File Offset: 0x001263C4
		...
		// Token: 0x060036F7 RID: 14071 RVA: 0x00126634 File Offset: 0x00126634
		...
		// Token: 0x060036F8 RID: 14072 RVA: 0x00126718 File Offset: 0x00126718
		...
		// Token: 0x060036F9 RID: 14073 RVA: 0x00126734 File Offset: 0x00126734
		private static int[] Square(int[] w, int[] x)
		{
			...
			{
				IntPtr intPtr;
				w[(int)(intPtr = (IntPtr)num)] = w[(int)intPtr] + (int)(num3 >> 32);
			}
			return w;
		}

		// Token: 0x060036FA RID: 14074 RVA: 0x00126818 File Offset: 0x00126818
		...
		// Token: 0x060036FB RID: 14075 RVA: 0x001268A8 File Offset: 0x001268A8
		...
		// Token: 0x060036FC RID: 14076 RVA: 0x001268F0 File Offset: 0x001268F0
		...
		// Token: 0x060036FD RID: 14077 RVA: 0x0012698C File Offset: 0x0012698C
		...
		// Token: 0x060036FE RID: 14078 RVA: 0x00126B54 File Offset: 0x00126B54
		...
		// Token: 0x060036FF RID: 14079 RVA: 0x00126D74 File Offset: 0x00126D74
		...
		// Token: 0x06003700 RID: 14080 RVA: 0x00126DB8 File Offset: 0x00126DB8
		...
		// Token: 0x06003701 RID: 14081 RVA: 0x00126EA0 File Offset: 0x00126EA0
		...
		// Token: 0x06003702 RID: 14082 RVA: 0x00126F1C File Offset: 0x00126F1C
		...
		// Token: 0x06003703 RID: 14083 RVA: 0x00126F40 File Offset: 0x00126F40
		...
		// Token: 0x06003704 RID: 14084 RVA: 0x00126FB0 File Offset: 0x00126FB0
		public BigInteger Not()
		{
			return this.Inc().Negate();
		}

		// Token: 0x06003705 RID: 14085 RVA: 0x00126FC0 File Offset: 0x00126FC0
		...
		// Token: 0x06003706 RID: 14086 RVA: 0x00127068 File Offset: 0x00127068
		public static BigInteger ProbablePrime(int bitLength, Random random)
		{
			return new BigInteger(bitLength, 100, random);
		}

		// Token: 0x06003707 RID: 14087 RVA: 0x00127074 File Offset: 0x00127074
		...
		// Token: 0x06003708 RID: 14088 RVA: 0x001270B4 File Offset: 0x001270B4
		...
		// Token: 0x06003709 RID: 14089 RVA: 0x0012725C File Offset: 0x0012725C
		...
		// Token: 0x0600370A RID: 14090 RVA: 0x00127358 File Offset: 0x00127358
		private int[] LastNBits(int n)
		{
			...
			{
				int[] array2;
				(array2 = array)[0] = (array2[0] & (int)(uint.MaxValue >> num2));
			}
			return array;
		}

		// Token: 0x0600370B RID: 14091 RVA: 0x001273CC File Offset: 0x001273CC
		...
		// Token: 0x0600370C RID: 14092 RVA: 0x0012741C File Offset: 0x0012741C
		...
		// Token: 0x0600370D RID: 14093 RVA: 0x00127464 File Offset: 0x00127464
		...
		// Token: 0x0600370E RID: 14094 RVA: 0x0012752C File Offset: 0x0012752C
		...
		// Token: 0x0600370F RID: 14095 RVA: 0x00127564 File Offset: 0x00127564
		...
		// Token: 0x06003710 RID: 14096 RVA: 0x00127610 File Offset: 0x00127610
		...
		// Token: 0x06003711 RID: 14097 RVA: 0x001276C4 File Offset: 0x001276C4
		...
		// Token: 0x06003712 RID: 14098 RVA: 0x00127708 File Offset: 0x00127708
				...
				else
				{
					...
					for (int i = num - 1; i >= 0; i--)
					{
						...
						if (num5 >= 0)
						{
							int[] array2;
							IntPtr intPtr;
							(array2 = array)[(int)(intPtr = (IntPtr)i)] = (array2[(int)intPtr] | this.magnitude[num5] << num4);
						}
					}
				}
				return new BigInteger(this.sign, array, false);
		...
		// (get) Token: 0x06003713 RID: 14099 RVA: 0x00127808 File Offset: 0x00127808
		...
		// Token: 0x06003714 RID: 14100 RVA: 0x00127810 File Offset: 0x00127810
		private static int[] Subtract(int xStart, int[] x, int yStart, int[] y)
		{
			...
			{
				IntPtr intPtr;
				while ((x[(int)(intPtr = (IntPtr)(--num))] = x[(int)intPtr] - 1) == -1)
				{
				}
			}
			return x;
		...
		// Token: 0x06003715 RID: 14101 RVA: 0x00127878 File Offset: 0x00127878
		...
		// Token: 0x06003716 RID: 14102 RVA: 0x0012791C File Offset: 0x0012791C
		...
		// Token: 0x06003717 RID: 14103 RVA: 0x00127944 File Offset: 0x00127944
		public byte[] ToByteArray()
		{
			return this.ToByteArray(false);
		}

		// Token: 0x06003718 RID: 14104 RVA: 0x00127950 File Offset: 0x00127950
		public byte[] ToByteArrayUnsigned()
		{
			return this.ToByteArray(true);
		}

		// Token: 0x06003719 RID: 14105 RVA: 0x0012795C File Offset: 0x0012795C
		...
		// Token: 0x0600371A RID: 14106 RVA: 0x00127B28 File Offset: 0x00127B28
		public override string ToString()
		{
			return this.ToString(10);
		}

		// Token: 0x0600371B RID: 14107 RVA: 0x00127B34 File Offset: 0x00127B34
		public string ToString(int radix)
		{
			...
			if (radix != 2)
			{
				...
				default:
					...
					{
						int num3 = num;
						stringBuilder.Append(Convert.ToString(this.magnitude[num3], 16));
						while (++num3 < this.magnitude.Length)
						{
							BigInteger.AppendZeroExtendedString(stringBuilder, Convert.ToString(this.magnitude[num3], 16), 8);
						}
					}
					break;
				}
			...
			{
				int num4 = num;
				stringBuilder.Append(Convert.ToString(this.magnitude[num4], 2));
				while (++num4 < this.magnitude.Length)
				{
					BigInteger.AppendZeroExtendedString(stringBuilder, Convert.ToString(this.magnitude[num4], 2), 32);
				}
			}
			return stringBuilder.ToString();
		}

		// Token: 0x0600371C RID: 14108 RVA: 0x00127DD8 File Offset: 0x00127DD8
		...
		// Token: 0x0600371D RID: 14109 RVA: 0x00127E88 File Offset: 0x00127E88
		...
		// Token: 0x0600371E RID: 14110 RVA: 0x00127EC0 File Offset: 0x00127EC0
		...
		// Token: 0x0600371F RID: 14111 RVA: 0x00127F2C File Offset: 0x00127F2C
		...
		// Token: 0x06003720 RID: 14112 RVA: 0x00127F68 File Offset: 0x00127F68
		...
		// Token: 0x06003721 RID: 14113 RVA: 0x00127F94 File Offset: 0x00127F94
		...
		// Token: 0x06003722 RID: 14114 RVA: 0x00127FAC File Offset: 0x00127FAC
		...
		// Token: 0x06003723 RID: 14115 RVA: 0x0012801C File Offset: 0x0012801C
		...
		// Token: 0x06003724 RID: 14116 RVA: 0x00128094 File Offset: 0x00128094
		...
		// Token: 0x06003725 RID: 14117 RVA: 0x001281F4 File Offset: 0x001281F4
		...
		// Token: 0x06003726 RID: 14118 RVA: 0x00128370 File Offset: 0x00128370
		...
		// Token: 0x06003727 RID: 14119 RVA: 0x001283D4 File Offset: 0x001283D4
		...
		// Token: 0x06003728 RID: 14120 RVA: 0x00128438 File Offset: 0x00128438
		...
		// Token: 0x06003729 RID: 14121 RVA: 0x00128490 File Offset: 0x00128490
		private BigInteger FlipExistingBit(int n)
		{
			int[] array = (int[])this.magnitude.Clone();
			int[] array2;
			IntPtr intPtr;
			(array2 = array)[(int)(intPtr = (IntPtr)(array.Length - 1 - (n >> 5)))] = (array2[(int)intPtr] ^ 1 << n);
			return new BigInteger(this.sign, array, false);
		}
