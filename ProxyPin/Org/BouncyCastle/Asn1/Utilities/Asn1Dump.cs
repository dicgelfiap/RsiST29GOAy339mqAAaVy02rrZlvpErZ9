...
namespace Org.BouncyCastle.Asn1.Utilities
{
	...
	{
		// Token: 0x06000EFA RID: 3834 RVA: 0x0005A1D8 File Offset: 0x0005A1D8
		private Asn1Dump()
		{
		}

		// Token: 0x06000EFB RID: 3835 RVA: 0x0005A1E0 File Offset: 0x0005A1E0
		private static void AsString(string indent, bool verbose, Asn1Object obj, StringBuilder buf)
		{
			...
			if (obj is Asn1TaggedObject)
			{
				...
				Asn1Dump.AsString(text2, verbose, asn1TaggedObject.GetObject(), buf);
				return;
			}
			else
			{
		...
		// Token: 0x06000EFC RID: 3836 RVA: 0x0005AD8C File Offset: 0x0005AD8C
		...
		// Token: 0x06000EFD RID: 3837 RVA: 0x0005AEDC File Offset: 0x0005AEDC
		...
		// Token: 0x06000EFE RID: 3838 RVA: 0x0005AF2C File Offset: 0x0005AF2C
		public static string DumpAsString(Asn1Encodable obj)
		{
			return Asn1Dump.DumpAsString(obj, false);
		}

		// Token: 0x06000EFF RID: 3839 RVA: 0x0005AF38 File Offset: 0x0005AF38
		...
		// Token: 0x06000F00 RID: 3840 RVA: 0x0005AF68 File Offset: 0x0005AF68
		...
		// Token: 0x06000F01 RID: 3841 RVA: 0x0005B064 File Offset: 0x0005B064
